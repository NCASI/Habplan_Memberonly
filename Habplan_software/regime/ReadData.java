...
public class ReadData{
 ...
 public ReadData(RegimeTable parentTable) {
...
public void write(String fileName, String[][] data){
 ...
 try{
	...
	out.newLine();
	   ...
	   JOptionPane.showMessageDialog(parentTable,"Write Error: "+e,
...
String delimiters=" \t\n\r,;";   
  ...
  try{	 
	...
	//delim is not a space for regime edits
     if (1==2 && pass==1 && nLines==0 && line.indexOf(" ")!=-1){
     ...
     JOptionPane.showMessageDialog(parentTable,"Error reading "+fileName,
